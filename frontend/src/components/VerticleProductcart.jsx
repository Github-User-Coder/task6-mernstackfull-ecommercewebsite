...
const VerticleProductcart = ({loading,data =[]}) => {
    const loadingList =new Array(13).fill(null)
  ...
  return (
    <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between md:gap-2 overflow-x-scroll scrollb-none transition-all'>
...
export default VerticleProductcart